...
Muhammad Nasir contributed to exercise two. Note: After merging, I realized the ProjectID for my Rstudio had somehow been replaced so I had to obtain the old version of my repo and copy and paste Muhammad's work in.
...
Note: I apologize for the late upload of the work, I uploaded it as soon as I received it.

## Muhammad's Boxplot

```{r, echo=FALSE, message=FALSE}
#| label: Boxplot
#| fig-cap: "Boxplot created for Exercise 2."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","boxplot-gender-height.png"))
```
...
```{r, echo=FALSE, message=FALSE}
#| label: Scatterplot
#| fig-cap: "Scatterplot created for Exercise 2."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","Scatterplot-Height-Weight.png"))
```
...
```{r}
#| label: QQ-Plot
#| fig-cap: "QQ-Plot created for Exercise 2."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","Ex2QQPlot.jpg"))
```
