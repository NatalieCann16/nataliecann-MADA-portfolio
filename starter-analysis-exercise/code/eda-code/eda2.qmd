...
```{r}
QQ_plot <- ggplot(mydata, aes(sample = Height)) +
  stat_qq() +
  stat_qq_line(color = "red") +
  labs(title = "Q-Q Plot for Height", x = "Theoretical Quantiles", y = "Sample Quantiles") +
  theme_minimal()

figure_file = here("starter-analysis-exercise","results","figures","QQ Plot  Height .png")
ggsave(filename = figure_file, plot= QQ_plot) 
```
