...
p1 <- mydata %>% ggplot(aes(x=Height)) + 
  geom_histogram() #Creating a histogram 
plot(p1)
figure_file = here("starter-analysis-exercise","results","figures","height-distribution.png") # Set up location for the plot created 
...
p4 <- mydata %>% ggplot(aes(x=Height, y=Weight, color = Gender)) + 
  geom_point() + 
  geom_smooth(method='lm') +
  scale_color_manual(values = c("M" = "yellow", "F" = "red", "O" = "blue")) + #to set choose different color 
  labs(color = "Gender")#color statement idicate the gender 
plot(p4)
...
#Note from Nasir
There is no problem on the provided code. Additionally, I added color statement to create differrent color in the plot. I also provide additional note in almost each line of the code. It will help us to understand the purpose of each line of the code as a learner. 
